...
st.code("console.log('Hello World')", language='javascript')  # You can specify the programming language for syntax highlighting
...
st.text(f"You selected: {option}")  # Displays the selected option dynamically
...
sidebar_option = st.sidebar.selectbox("Select option are ( A, B, C)", ["A", "B", "C"])